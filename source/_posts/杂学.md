...
＊註冊帳號需要用日本手機號，往一個號碼裡打電話（發券時不查）。
＊不收海外發行的信用卡。（解決方法見下）

### 2. ローチケ

＊註冊帳號需要填日本手機號，但是不當場驗證。所以可以先填，等落地日本以後激活號碼後再發券。
＊發券使用ローチケApp，需要用日本手機號發短信。

## 日本信用卡

玩日本虛擬卡的人太少了，看不到什麼公開情報。也許都在悶聲發大財？那我也來當謎語人。

提示：`kyash` + `JCB` （需日本手機號），合成一張`visa debit`。

同類平台還有`ANA` 和 `vプリカ`，但是充值麻煩。
